...
<body style="font-family: Arial, Helvetica, sans-serif; color: Blue; background-color: #C0C0C0 		;">

<form id="myform" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >


<h1 style="background-color: #202020 ; padding:25px;color:white;"><center>Login Validation</center></h1>
...
$sql_statement .= "AND password = '".$pass1."' ";
...
<hr size="4" style="background-color: #ff8533; color: #F5DEB3;" />
